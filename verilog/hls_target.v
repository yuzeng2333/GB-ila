...
hls_target_Loop_1_proc hls_target_Loop_1_proc_U0(
    ...
    .p_p2_in_bounded_stencil_stream_V_value_V_dout( hls_target_Loop_1_proc_U0_p_p2_in_bounded_stencil_stream_V_value_V_dout ), // 1, input
    .p_p2_in_bounded_stencil_stream_V_value_V_empty_n( hls_target_Loop_1_proc_U0_p_p2_in_bounded_stencil_stream_V_value_V_empty_n ), // 2, input
    .p_p2_in_bounded_stencil_stream_V_value_V_read( hls_target_Loop_1_proc_U0_p_p2_in_bounded_stencil_stream_V_value_V_read ), // 3, output
...
FIFO_hls_target_p_p2_in_bounded_stencil_stream_s p_p2_in_bounded_stencil_stream_s_U(
    ...
    .if_dout( p_p2_in_bounded_stencil_stream_s_dout ), // 1, output
    .if_empty_n( p_p2_in_bounded_stencil_stream_s_empty_n ), // 2, output
    .if_read( p_p2_in_bounded_stencil_stream_s_read ) // 3. input
);
