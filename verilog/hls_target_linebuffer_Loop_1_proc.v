...
always @ (posedge ap_clk) begin : ap_ret_ap_CS_fsm
    if (ap_rst == 1'b1) begin
        ap_CS_fsm <= ap_ST_st1_fsm_0;  // 3'b001
    end else begin
        ap_CS_fsm <= ap_NS_fsm;
    end
end
...
always @ (ap_CS_fsm or exitcond_flatten_fu_72_p2 or ap_sig_bdd_114 or ap_reg_ppiten_pp0_it0 or ap_sig_bdd_121 or ap_reg_ppiten_pp0_it1 or ap_sig_bdd_142) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : // 3'b001
        begin
            if (~ap_sig_bdd_142) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_1; // 3'b010
            end else begin
                ap_NS_fsm = ap_ST_st1_fsm_0; // 3'b001
            end
        end
        ap_ST_pp0_stg0_fsm_1 : // 3'b010
        begin
